...
export default function WorkPage_Cobblestone() {
  const colors = ["#FFF8DE", "#9ECB96", "#B8B2FF"];
  const title= "Cobblestone Shader";
  const desc = "A fully procedural shader that converts any surface into customizable, real-time growth cobblestone without texture maps.";
  const links: any[]=[];
