...
import info from "../../../content/ninjamouse_content";
import { GoStack } from "react-icons/go";
import BlobBg from "../../../styles/BlobBg";
import ReactPlayer from 'react-player'

export default function WorkPage_NinjaMouse() {
  const colors = ["#FFF8DE", "#9ECB96", "#B8B2FF"];
  const title= "Ninja Mouse";
  const desc = "A custom-built 3D C++ engine featuring modular architecture, real-time physics, and AI systems, validated through an interactive gameplay demo.";
  const links: any[]=[{label:"Github", href:"https://github.com/jjesswan/3d-game-engine"}];
  const header_img = "/images/NinjaMouse/header.jpg";
  const product_img = "/images/NinjaMouse/full_demo_optimized.mp4";
  const libraries = "OpenGL, GLSL, QT, Blender, GLAD";
          ...
          {/*///////////////////////////// SHOWCASE AREA ////////////////////////*/}
           <Flex w="100%" mt="10rem" px={{lg: "5rem", base: "rem"}} flexDir={"column"}>
            ...
            <CornerBrackets color="#eb5c68" size={30} thickness="6px" child={
              <ReactPlayer src={product_img} controls={true} width="100%" height="auto" style={{padding: "1rem", borderRadius: ".5rem"}} />
            }/>
