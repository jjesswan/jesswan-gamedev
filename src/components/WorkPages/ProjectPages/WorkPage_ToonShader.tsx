...
import info from "../../../content/toonshader_content";
import { GoStack } from "react-icons/go";
import BlobBg from "../../../styles/BlobBg";
import React from 'react'
import ReactPlayer from 'react-player'

export default function WorkPage_ToonShader() {
  const colors = ["#FFF8DE", "#9ECB96", "#B8B2FF"];
  const title= "Toon Shader";
  const desc = "A custom toon shader implementation for Unreal Engine.";
  const links: any[]=[];
  const header_img = "/images/ToonShader/preview.jpg";
  const product_img = "/images/ToonShader/demo.gif";
  const libraries = "Unreal Engine";
